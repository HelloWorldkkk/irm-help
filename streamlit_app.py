...
if __name__ == "__main__":
    openai_api_key = st.sidebar.text_input('Input Your OpenAI API Key', type='password')

    os.environ["OPENAI_API_TYPE"] = "azure"
    os.environ["OPENAI_API_VERSION"] = "2023-05-15"
    os.environ["OPENAI_API_BASE"] = "https://pvg-azure-openai-uk-south.openai.azure.com/openai"
    # env_path = os.getenv("HOME") + "/Documents/Jupyter/llm-learning/openai/env.env"
    # load_dotenv(dotenv_path=env_path, verbose=True)
    os.environ["AZURE_OPENAI_API_KEY"] = openai_api_key

    st.title('IRM Help Assistant')
